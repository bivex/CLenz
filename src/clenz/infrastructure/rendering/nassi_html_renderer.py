...
from clenz.domain.ports import NassiDiagramRenderer
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Nassi-Shneiderman control flow diagram for C source code">
  ...
  <body>
    <div class="viewer">
      <div class="titlebar">
        ...
        <span class="titlebar-text">CLenz · NSD Viewer</span>
      </div>
      <div class="toolbar">
...
"""
    ...
    def _render_step(self, step: ControlFlowStep, *, depth: int) -> str:
        ...
        if isinstance(step, ForFlowStep):
